...
from schemas.schemas_payloads import StatusPayload
...
class EventPublisher:
    ...
    '''
    def publish (self) -> StatusPayload:
        ...
        try: 
            ...
            logger.info(f'Published new event: {future} to topic: {topic_path}')
        
            return StatusPayload(status="successful", message="event published")
