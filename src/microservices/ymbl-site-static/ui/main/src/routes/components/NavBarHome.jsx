...
export default function NavBar() {
    ...
    return (
        <nav>
            <div className="hidden md:flex justify-center p-5 bg-white pb-12 pt-7">
                <ul className="flex font-bold text-3xl space-x-16 text-gray-800  cursor-pointer">
                    <li className="mr-6">
                        <a className="hover:text-gray-400" onClick={renderHomePage}>Home</a>
                    </li>
                    {/* <li className="mr-6">
                        <a className="text-orange-500 hover:text-orange-600 cursor-pointer" onClick={renderRegistrationPage}>Register</a>
                    </li> */}
                    <li className="mr-6">
                        <a className="hover:text-gray-400" onClick={renderSchedulePage}>Schedule</a>
                    </li>
                    <li className="mr-6">
                        <a className="hover:text-gray-400" onClick={renderStatsPage}>Stats</a>
                    </li>
                    <li className="mr-6">
                        <a className="hover:text-gray-400" onClick={renderAboutPage}>About</a>
                    </li>
                    {/* <li className="mr-6">
            ...
            <div className="hidden mobile-menu bg-white">
                <ul className="text-md">
                    <li className="">
                        <a onClick={renderHomePage} className="block px-2 py-4 text-orange-500 hover:bg-gray-100 font-bold">Home</a>
                    </li>
                    {/* <li className="">
                    ...
                    <li className="">
                        <a onClick={renderSchedulePage} className="block px-2 py-4 text-orange-500 hover:bg-gray-100 font-bold">Schedule</a>
                    </li>
                    <li className="">
                        <a onClick={renderAboutPage} className="block px-2 py-4 text-orange-500 hover:bg-gray-100 font-bold">About</a>
                    </li>
                    {/* <li className="">
