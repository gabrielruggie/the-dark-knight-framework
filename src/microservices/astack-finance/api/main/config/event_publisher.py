...
class EventPublisher:
    ...
    def publish (self) -> Response:
        ...
        try: 
            ...
            return Response(http_code=500, error_code=340, msg='An unexpected error occurred while processing your request. Please inform your supervisor of this error.')